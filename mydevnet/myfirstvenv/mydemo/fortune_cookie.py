...
def create_fortune_cookie_message(how_many_lucky_numbers: int) -> str:
    ...
    # cookie's message.
    furntune = generate_fortune()
    cookie_message = generate_lucky_numbers(how_many_lucky_numbers)
    return f"{furntune}\nLucky Number:{cookie_message}".format(furntune=furntune,cookie_message=cookie_message)
